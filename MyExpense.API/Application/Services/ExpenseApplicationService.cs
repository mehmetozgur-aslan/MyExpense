...
namespace MyExpense.API.Application.Services;

public sealed class ExpenseApplicationService : IExpenseApplicationService
{
    private readonly ExpenseDbContext dbContext;

    public ExpenseApplicationService(ExpenseDbContext dbContext)
    {
